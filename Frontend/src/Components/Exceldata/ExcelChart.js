...
import '../commonstyle/bargraph.css';
...
const ExcelPieChart = () => {
  ...
  return (
    <div className='data-container'>
      <Navbar/>
      <h1 className='excelheading'>Data Visualization</h1>
      <h2 className='excelhead'>Age</h2>
      <Chart
        width={'500px'}
        height={'300px'}
      ...
      <h2 className='excelhead'>Gender</h2>
      <Chart
        width={'500px'}
        height={'300px'}
        chartType="ColumnChart"
      ...
      <h2 className='excelhead'>Favorite Bike</h2>
      <Chart
        width={'500px'}
        height={'300px'}
        chartType="PieChart"
